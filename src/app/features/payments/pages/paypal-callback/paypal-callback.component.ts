 ...
 * Handles the callback redirect from PayPal after subscription approval
 *
 * This component is loaded when PayPal redirects the user back to our app.
 * It handles:
 * 1. Success - subscription was approved
 * 2. Cancelled - user cancelled the subscription process
 */
@Component({
      ...
      <div class="callback-card">
        ...
        @if (isVerifying()) {
          <div class="callback-loading">
            ...
            <p>Please wait while we confirm your PayPal subscription...</p>
          </div>
        }
        ...
        @if (isSuccess()) {
          <div class="callback-success">
            ...
            <p>Your PayPal subscription has been set up successfully.</p>
        ...
        @if (isCancelled()) {
          <div class="callback-cancelled">
            ...
            <p>You cancelled the PayPal subscription process. No charges were made.</p>
